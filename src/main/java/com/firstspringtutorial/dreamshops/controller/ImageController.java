...
import com.firstspringtutorial.dreamshops.service.image.IImageService;
...
public class ImageController {
    ...
    public ResponseEntity<ApiResponse> updateImages(@PathVariable Long imageId , @RequestBody MultipartFile file ){
        ...
        return ResponseEntity.status(INTERNAL_SERVER_ERROR).body(new ApiResponse("Update Success! " , INTERNAL_SERVER_ERROR));
    }

    @DeleteMapping ("/image/{imageId}/update")
    public ResponseEntity<ApiResponse> deleteImages(@PathVariable Long imageId){
        try {
             Image image = imageService.deleteImageById(imageId);
            if (image != null){
